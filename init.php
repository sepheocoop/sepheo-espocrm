...
if ($es6) {
    ...
    $path =
        'src/files/custom/Espo/Modules/MyModuleName/Resources/metadata/app/';
...
rename(
    'src/files/custom/Espo/Modules/MyModuleName',
    'src/files/custom/Espo/Modules/' . $name,
);
rename(
    'src/files/client/custom/modules/my-module-name',
    'src/files/client/custom/modules/' . $nameHyphen,
);

rename(
    'tests/unit/Espo/Modules/MyModuleName',
    'tests/unit/Espo/Modules/' . $name,
);
rename(
    'tests/integration/Espo/Modules/MyModuleName',
    'tests/integration/Espo/Modules/' . $name,
);
